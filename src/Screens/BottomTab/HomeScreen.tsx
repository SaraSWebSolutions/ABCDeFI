...
//   const { timerIcoData, error } = useSelector((state: RootState) => state.home);
...
//               logoUrl:
//                 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLY6djbwpi-PHMMo0y-UaZbdAticD21Of3XQ&s',
//             },
//           },
//         });
//         return wallet;
...
//             <Text style={styles.joinText}>Join ICO Before Timer Ends</Text>
//           </LinearGradient>
//           {/* JOIN ICO BUTTON */}
...
//       paddingTop: hp(2),
//       // paddingBottom: hp(12),
//         paddingBottom: Platform.OS === 'ios' ? hp(15) : hp(12),
...
//   timerRow: {
//   flexDirection: 'row',
//   justifyContent: Platform.OS === 'ios'
//     ? 'space-evenly'
//     : 'space-between',
//   alignItems: 'center',
// },
...
//   borderRadius: Platform.OS === 'ios' ? wp(8) : wp(9),
